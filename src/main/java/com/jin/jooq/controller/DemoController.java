...
public class DemoController {
    ...
    @RequestMapping("demo")
    public @ResponseBody String demoController(){
        List<Register> all = demoService.findAll();
        return all.toString();
    }

    @RequestMapping("demo2")
    public @ResponseBody String demoController2(){
    ...
    public @ResponseBody String demoController3(){
        Register register=new Register();
    ...
    public @ResponseBody String demoController4(){
        Register register=new Register();
        register.setRegisterno(4);
    ...
    public @ResponseBody String demoController5(){
        Register register=new Register();
        register.setRegisterno(4);
